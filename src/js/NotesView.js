export default class NotesView {
  ...
  _createListItemHTML(id, title, body, updated) {
    ...
    <div class="notes-small-title p-3 text-xl">${title}</div>
        <span class="note-list-trash" data-note-id="${id}"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class=" w-5 h-5 stroke-red-500 hover:stroke-white ">
            <path
